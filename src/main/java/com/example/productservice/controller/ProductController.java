...
//        }
    ...
    @GetMapping("/getall")
    public ResponseEntity<List<Product1DTO>> getAll(){
        return new ResponseEntity<List<Product1DTO>>(productService.getAll(), HttpStatus.OK);
    }
    ...
    @GetMapping("/getAllSolar")
    public ResponseEntity<List<SolarDTO>> getAllSolar() {
        return new ResponseEntity<>(productService.getAllSolar(), HttpStatus.OK);
    }


    @GetMapping("/listOfProductsByCategoryName/{name}")
    public ResponseEntity<List<Product>> listOfProductsByCategory(@PathVariable("name") String Name){
        return new ResponseEntity<>(productService.listOfProductsByCategoryName(Name),HttpStatus.ACCEPTED);
    }
